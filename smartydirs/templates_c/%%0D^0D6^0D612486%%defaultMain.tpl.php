<?php /* Smarty version 2.6.17, created on 2015-07-13 09:52:42
...
" />
    	<LINK REL="Shortcut icon" HREF="<?php echo $this->_tpl_vars['ikona']; ?>
" />
...
<?php echo $this->_tpl_vars['PokazKoszykStatus']; ?>
			...
			<td height="266" width="100%" align="center">
				...
				<tr>
					...
					<table width="200px" align="right">
						...
						<tr><td>
							<div class="font_sm">
							<?php echo $this->_tpl_vars['KontaktHeader']; ?>
...
<br/><br/>
		...
		<tr>
			<td colspan="2" width="*" align="center"><?php echo $this->_tpl_vars['menuBottom']; ?>
</td>
		</tr>
	</table>	
	</center>
