<?php /* Smarty version 2.6.17, created on 2014-07-10 17:29:25
         compiled from modules/AktualnosciFull.tpl */ ?>
...
?>
	<tr>
		<td width="620" align="left"><div class="granat"><?php echo $this->_tpl_vars['aktItem']->tytul; ?>
 | <?php echo $this->_tpl_vars['aktItem']->data; ?>
</div></td>
	</tr>
	<tr>
		<td colspan="2" width="620">
			<?php echo $this->_tpl_vars['aktItem']->tresc; ?>
...
?>
		...
		<?php else: ?>
			<a href="?mp=<?php echo $this->_tpl_vars['nextPageAct']; ?>
&page=<?php echo $this->_tpl_vars['pagesItem']; ?>
"><?php echo $this->_tpl_vars['pagesItem']; ?>
</a>
		<?php endif; ?>
		<?php endforeach; endif; unset($_from); ?>	
