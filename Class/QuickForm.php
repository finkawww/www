 ...
 */
require_once '/home4/finka/php/HTML/Common.php';
    ...
    */
    function &defaultRenderer()
    {
        if (!isset($GLOBALS['_HTML_QuickForm_default_renderer'])) {
			...
			$tmp = new HTML_QuickForm_Renderer_Default();
            $GLOBALS['_HTML_QuickForm_default_renderer'] =$tmp;
        }
    ...
    function toArray($collectHidden = false)
    {
		...
		$tmp = new HTML_QuickForm_Renderer_Array($collectHidden);
        $renderer =$tmp;
        $this->accept($renderer);
